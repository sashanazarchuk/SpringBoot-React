            ...
            <div className="p-8 rounded border border-gray-200">
                ...
                <form onSubmit={onSubmitHandler}>
                    <div className="mt-8 grid lg:grid-cols-1 gap-4">
                        <div>
                            <label htmlFor="name" className="text-sm text-gray-700 block mb-1 font-medium">Назва</label>
                            <input
                                type="text"
                                name="name"
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows={4}
                                className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border-gray-300"
